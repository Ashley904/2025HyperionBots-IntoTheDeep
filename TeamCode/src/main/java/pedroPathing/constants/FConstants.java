...
public class FConstants {
    static {
        ...
        FollowerConstants.translationalPIDFCoefficients.setCoefficients(0.25,0,0.01,0.0025);
        ...
        FollowerConstants.drivePIDFCoefficients.setCoefficients(0.0135,0,0.000,0.6,0.0006);
        FollowerConstants.useSecondaryDrivePID = true;
        FollowerConstants.secondaryDrivePIDFCoefficients.setCoefficients(0.009,0,0.0001,0.6,0); // Not being used, @see useSecondaryDrivePID

        FollowerConstants.zeroPowerAccelerationMultiplier = 4;
        FollowerConstants.centripetalScaling = 0.000425;

        FollowerConstants.pathEndTimeoutConstraint = 60;
